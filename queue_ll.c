...
int dequeue(Queue **h, bool *rcode)
{
    if (*h == NULL && tail == NULL)
    {
        printf("Queue empty!\n");
...
int main()
{
    ...
    menu();
    printf("Enter 1 or 2 to choose an action. Anything else to quit.\n");
    scanf("%d", &option);
    fflush(stdin);
    while (option == 1 || option == 2)
    {
        ...
        menu();
        printf("Enter 1 or 2 to choose an action. Any other number to quit.\n");
        fflush(stdin);
        scanf("%d", &option);
        fflush(stdin);
    }
